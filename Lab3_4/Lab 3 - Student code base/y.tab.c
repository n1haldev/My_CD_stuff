...
static const yytype_int8 yyrline[] =
{
      ...
      44,    45,    60,    61,    62,    63,    67,    80,    81,    84,
      85,    86,    90,    91,    92,    95,    96,    97,    98,   101,
     102,   103,   104,   105,   106,   111,   111,   113,   114,   117,
     118,   119,   123,   124,   127,   127
};
#endif
...
{
      10,   -22,   -22,   -22,   -22,   -20,    24,   -22,   -12,    18,
       4,    10,    12,   -22,    10,    13,   -20,    -1,   -22,   -22,
      10,   -22,   -22,   -22,   -22,    12,    -3,   -13,    -8,   -22,
     -22,    25,    25,   -22,    -7,   -22,   -22,   -22,   -22,   -22,
     -22,    12,    12,    12,    12,    12,    -1,     9,   -22,   -22,
     -13,    -8,    -8,   -22,   -22,    27,   -22,    -2,   -22,    39,
      25,    40,    29,    -2,    -2,    -2,   -22,   -22,   -22,   -22,
     -22,    30,   -22
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     6,     0,     1,     6,     0,    11,     7,     9,    10,
       6,     3,    28,    26,    27,     0,    16,    18,    21,    24,
       4,    38,     0,     5,     0,    33,    34,    30,    29,    31,
      32,     0,     0,     0,     0,     0,    37,     0,     8,    25,
      17,    19,    20,    22,    23,     0,    35,    41,    44,     0,
       0,     0,     0,    41,    41,    41,    42,    43,    36,    39,
      40,     0,    45
};
...
{
     -22,   -22,     5,    -5,    42,    43,     0,    -9,    49,    35,
      19,    22,   -22,   -22,   -22,   -22,   -21,   -22,   -22,   -22
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     6,     7,     8,    17,    18,     9,    10,    26,    27,
      28,    29,    41,    11,    57,    47,    62,    63,    64,    65
};
...
{
      19,     1,     2,     3,    35,    36,    37,    38,    35,    36,
      37,    38,    12,     1,     2,     3,    21,     4,    14,    30,
      42,    43,    19,    19,    13,    33,     5,    44,    45,     4,
      32,    49,    39,    40,    20,    22,    39,    40,     5,    58,
      23,    24,    69,    70,    71,    15,    16,    55,    61,    25,
      31,    19,    59,    16,    61,    61,    61,    60,    59,    59,
      59,    51,    52,    60,    60,    60,    53,    54,    56,    66,
      67,    68,    72,    46,    34,    48,    50
};

static const yytype_int8 yycheck[] =
{
       9,     3,     4,     5,    11,    12,    13,    14,    11,    12,
      13,    14,    32,     3,     4,     5,    11,    19,    30,    14,
      33,    34,    31,    32,     0,    20,    28,    35,    36,    19,
      31,    38,    39,    40,    30,    23,    39,    40,    28,    41,
      28,    29,    63,    64,    65,    27,    28,    38,    57,    37,
      37,    60,    57,    28,    63,    64,    65,    57,    63,    64,
      65,    42,    43,    63,    64,    65,    44,    45,    41,    30,
      30,    42,    42,    31,    25,    32,    41
};
...
static const yytype_int8 yystos[] =
{
      ...
      50,    56,    32,     0,    30,    27,    28,    47,    48,    50,
      30,    45,    23,    28,    29,    37,    51,    52,    53,    54,
      45,    37,    31,    45,    51,    11,    12,    13,    14,    39,
      40,    55,    33,    34,    35,    36,    47,    58,    48,    38,
      52,    53,    53,    54,    54,    38,    41,    57,    41,    46,
      49,    50,    59,    60,    61,    62,    30,    30,    42,    59,
      59,    59,    42
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* START: PROG  */
#line 26 "parser_lab3.y"
             { printf("Valid syntax\n"); YYACCEPT; }
#line 1282 "y.tab.c"
    break;

  case 11: /* VAR: T_ID  */
#line 45 "parser_lab3.y"
                        {
				/*
                    		...
                    		*/
				if(check_symbol_table(yyvsp[0]) == 1)
					yyerror("Variable is redeclared!");
				else {
					insert_into_table(yyvsp[0], size, type, yylineno, scope);
				}
			}
#line 1300 "y.tab.c"
    break;
  ...
  case 12: /* TYPE: T_INT  */
#line 60 "parser_lab3.y"
             { type = INT; size = 4; }
#line 1306 "y.tab.c"
    break;

  case 13: /* TYPE: T_FLOAT  */
#line 61 "parser_lab3.y"
                 { type = FLOAT; size = 4; }
#line 1312 "y.tab.c"
    break;

  case 14: /* TYPE: T_DOUBLE  */
#line 62 "parser_lab3.y"
                  { type = DOUBLE; size = 8; }
#line 1318 "y.tab.c"
    break;

  case 15: /* TYPE: T_CHAR  */
#line 63 "parser_lab3.y"
                { type = CHAR; size = 1; }
#line 1324 "y.tab.c"
    break;

  case 16: /* ASSGN: T_ID '=' EXPR  */
#line 67 "parser_lab3.y"
                        {
				/*
					to be done in lab 3
				*/
				if(check_symbol_table(yyvsp[-2]) == 1)
					yyerror("Variable is redeclared!");
				else {
					insert_into_table(yyvsp[-2], size, type, yylineno, scope);
					insert_value_to_name(yyvsp[-2], yyvsp[0]);
				}
			}
#line 1340 "y.tab.c"
    break;
