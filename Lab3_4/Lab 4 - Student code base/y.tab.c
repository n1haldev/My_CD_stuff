...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_REL_OP = 58,                    /* REL_OP  */
  YYSYMBOL_MAIN = 59,                      /* MAIN  */
  YYSYMBOL_60_2 = 60,                      /* $@2  */
  YYSYMBOL_EMPTY_LISTVAR = 61,             /* EMPTY_LISTVAR  */
...
static const yytype_uint8 yyrline[] =
{
      ...
      44,    56,    69,    70,    71,    72,    76,    76,    86,    87,
      90,   102,   114,   118,   130,   142,   145,   146,   166,   175,
     185,   186,   189,   190,   191,   196,   197,   198,   199,   200,
     201,   206,   206,   208,   209,   212,   213,   214,   218,   219,
     222,   222,   227,   228
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LISTVAR", "VAR", "TYPE", "ASSGN", "$@1", "EXPR", "E", "T", "F",
  "IF_STMT", "STMT", "REL_OP", "MAIN", "$@2", "EMPTY_LISTVAR",
...
{
      32,   -24,   -24,   -24,   -24,   -24,     8,   -24,   -20,   -22,
     -17,    32,     2,   -24,    32,    -5,    11,    14,   -24,    32,
     -24,    43,   -24,    25,    43,    25,   -24,   -24,   -24,   -24,
      43,    17,   -18,   -10,   -24,    14,    20,    17,   -24,    10,
     -24,   -24,   -24,   -24,   -24,   -24,    43,    43,    43,    43,
      43,    22,   -24,   -18,   -10,   -10,   -24,   -24,   -24,    -1,
      18,   -24,    37,    25,    40,    -1,    35,    -1,    -1,    55,
      -1,   -24,   -24,   -24,   -24,   -24,   -24,    42,   -24,    17,
      44,    39,    -1,   -24,    53,    -1,   -24
};
...
static const yytype_int8 yydefact[] =
{
       ...
       3,     0,     4,    44,     0,     0,     5,    29,    27,    28,
       0,    17,    19,    22,    25,    43,     0,    10,     8,     0,
      39,    40,    36,    35,    37,    38,     0,     0,     0,     0,
       0,     0,    26,    18,    20,    21,    23,    24,    41,    47,
       0,    50,     0,     0,     0,    47,     0,    47,    47,     0,
      47,    48,    49,    34,    42,    32,    33,    27,    53,    52,
       0,     0,    47,    51,    30,    47,    31
};
...
{
     -24,   -24,    -2,    33,    62,    61,    54,     0,   -24,   -23,
      41,    -9,    -8,   -24,    -6,   -24,   -24,   -24,   -24,   -24,
     -24,   -24,   -24
};
...
{
       0,     6,     7,    62,    17,    18,    63,    64,    12,    31,
      32,    33,    34,    65,    66,    46,    11,    59,    36,    67,
      68,    70,    80
};
...
{
      10,    37,     1,     2,     3,    15,    16,    39,    13,    20,
      14,    10,    22,    19,    10,    47,    48,    26,     4,    10,
      60,    40,    41,    42,    43,    49,    50,     5,    40,    41,
      42,    43,    23,     8,    21,     1,     2,     3,    54,    55,
      61,    56,    57,    24,     8,    25,    79,     8,    52,    44,
      45,     4,     8,    16,     9,    69,    44,    45,    51,    73,
       5,    75,    76,    58,    81,     9,    27,    71,     9,    78,
      72,    28,    29,     9,   -16,    85,    84,    74,    27,    86,
      30,    83,    82,    77,    29,    35,    38,    53,     0,     0,
       0,     0,    30
};

static const yytype_int8 yycheck[] =
{
       0,    24,     3,     4,     5,    27,    28,    30,     0,    11,
      30,    11,    14,    30,    14,    33,    34,    19,    19,    19,
      21,    11,    12,    13,    14,    35,    36,    28,    11,    12,
      13,    14,    37,     0,    32,     3,     4,     5,    47,    48,
      41,    49,    50,    32,    11,    31,    69,    14,    38,    39,
      40,    19,    19,    28,     0,    37,    39,    40,    38,    65,
      28,    67,    68,    41,    70,    11,    23,    30,    14,    69,
      30,    28,    29,    19,    32,    22,    82,    42,    23,    85,
      37,    42,    38,    28,    29,    23,    25,    46,    -1,    -1,
      -1,    -1,    37
};
...
static const yytype_int8 yystos[] =
{
      ...
      50,    59,    51,     0,    30,    27,    28,    47,    48,    30,
      45,    32,    45,    37,    32,    31,    45,    23,    28,    29,
      37,    52,    53,    54,    55,    47,    61,    52,    48,    52,
      11,    12,    13,    14,    39,    40,    58,    33,    34,    35,
      36,    38,    38,    53,    54,    54,    55,    55,    41,    60,
      21,    41,    46,    49,    50,    56,    57,    62,    63,    37,
      64,    30,    30,    57,    42,    57,    57,    28,    50,    52,
      65,    57,    38,    42,    57,    22,    57
};
...
#line 44 "parser.y"
                        {
				if(check_symbol_table(yyvsp[-2]))
				{
					printf("Variable %s already declared\n",yyvsp[-2]);
					yyerror(yyvsp[-2]);
				} else{
					insert_into_table(yyvsp[-2],strlen(yyvsp[-2]),type,yylineno,scope);
					insert_value_to_name(yyvsp[-2],vval,yylineno);
					vval="~";
					type=-1;
				}
			}
...
#line 56 "parser.y"
                {
				if(check_symbol_table(yyvsp[0]))
				{
					printf("Variable %s already declared\n",yyvsp[0]);
					yyerror(yyvsp[0]);
				} else {
					insert_into_table(yyvsp[0],strlen(yyvsp[0]),type,yylineno,scope);
					insert_value_to_name(yyvsp[0],vval,yylineno);
					type=-1;
				}
			}
#line 1331 "y.tab.c"
...
#line 76 "parser.y"
                                                {
            if (!check_symbol_table(yyvsp[-3])) {
                printf("Variable %s not declared\n", yyvsp[-3]);
                yyerror(yyvsp[-3]);
            } else {
                insert_value_to_name(yyvsp[-3], vval, yylineno);
            }
        }
#line 1374 "y.tab.c"
    break;
...
#line 90 "parser.y"
			...
			if(vtype==2)
				...
				sprintf(yyval,"%1f",(atof(yyvsp[-2])+atof(yyvsp[0])));
			else
			{
...
#line 146 "parser.y"
		...
		if(check_symbol_table(yyvsp[0]))
		{
			...
			if(check=="~")
			{
				printf("Variable is not initialised",yyvsp[0]);
				yyerror(yyval);
			}
			else{
				yyval=strdup(check);
...
#line 1518 "y.tab.c"
  ...
  case 42: /* MAIN: TYPE T_MAIN '(' EMPTY_LISTVAR ')' '{' $@2 STMT '}'  */
#line 206 "parser.y"
                                                               {scope--;}
#line 1524 "y.tab.c"
    break;
